...
// Make sure to uint8_t or uint32_t, you are dealing with system dependant sizes
...
// \param dst the variable that will be contian the copied contents from the file
...
bool endianess_converter(const char *src_data, uint32_t *dst_data, const size_t src_count);
